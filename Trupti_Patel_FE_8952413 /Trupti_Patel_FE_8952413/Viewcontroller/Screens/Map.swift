...
class Map: UIViewController,
    ...
    //Here are Properties to call the elements from the mapkit library
    ...
    //Here is the function that i set up for the Slider Configuration
    ...
    //Here I'm declaring Function to show an alert and take city input from the user
    func gtCtyName() {
    ...
    //Here I'm declaring function for geocoder
    ...
    //Here i am declaring function for getdirection
    ...
    //Here is the function for CLLocationManagerDelegate Methods
    ...
    //Here I'm calling faction for the mapview
    ...
    //Here is the Helper function to fetch the current city name using reverse geocoding
